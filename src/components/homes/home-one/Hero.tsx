...
const hero_data: string[] = ["Pipeline Velocity", "ABM Excellence", "Global Reach", "Metanova Tech"];
...
const Hero = () => {
   return (
      <div className="td-hero-area td-hero-spacing p-relative fix z-index-1">
         ...
         <div className="td-hero-text-slide wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
